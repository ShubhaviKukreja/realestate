                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Discover a seamless selling experience with our dedicated team. From property valuation to closing the deal, we're here to make the selling process stress-free and rewarding.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Explore our extensive range of rental properties. Whether you're a tenant seeking a new home or a landlord looking for reliable tenants, our rental services are tailored to meet your requirements</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Browse through our curated property listings, featuring a diverse range of homes and investment opportunities. Each listing is carefully vetted to ensure quality and value for our clients.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Invest with confidence knowing that our legal investment services prioritize transparency and compliance. Our team navigates the legal landscape to ensure your real estate investments are secure and profitable.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Discover why we're consistently rated as a top-tier real estate agency. Our satisfied clients and industry recognition speak volumes about the quality of our services.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Experience the unparalleled quality of our real estate services. From dream homes to lucrative investments, our portfolio reflects the excellence we bring to every transaction.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Meet our team of seasoned real estate professionals, each bringing a wealth of experience and expertise to guide you through every step of your real estate journey.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Initiate your real estate journey with a personalized discussion. Our team sits down with you to understand your goals, preferences, and any specific requirements you may have for buying, selling, or investing.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once we understand your objectives, our team conducts a thorough review of relevant documents and property files. This step ensures that all necessary legal and transactional aspects are in order.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>With the review complete, it's time to move forward. Whether you're acquiring a new property or finalizing a sale, our team handles the entire process, ensuring a seamless and efficient transaction.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='Kolkata'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
								...
								<h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Testimonial</h4>
									<div class="recent-review owl-carousel owl-dots-gray owl-dots-hover-success">
										...
										<div class="item">
                                            ...
                                            <div class="p-4 bg-success down-angle-white position-relative">
												<span class="text-black d-table text-capitalize"><?php echo $row['uname']; ?></span> <span class="text-capitalize"><?php echo $row['utype']; ?></span>
											</div>
